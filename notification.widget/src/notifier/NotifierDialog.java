...
import cache.ColorCache;
import cache.FontCache;
...
public class NotifierDialog {
    ...
    private static Color       _bgFgGradient = ColorCache.getColor(50, 50, 50);
    // shell gradient background color - bottom    
    private static Color       _bgBgGradient = ColorCache.getColor(150, 150, 150);
    // shell border color
    private static Color       _borderColor  = ColorCache.getColor(255, 255, 255);
     ...
     * @param type
     */
    public static void notify(Shell shell, String title, String message, Image img) {
